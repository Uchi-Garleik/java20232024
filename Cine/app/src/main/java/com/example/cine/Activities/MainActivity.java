package com.example.cine.Activities;
...
import com.example.cine.Adapters.CategoryListAdapter;
import com.example.cine.Adapters.FilmListAdapter;
import com.example.cine.Adapters.SliderAdapters;
import com.example.cine.Domain.GenresItem;
import com.example.cine.Domain.ListFilm;
import com.example.cine.Domain.SliderItems;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void sendRequestBestMovies() {
        ...
        mStringRequest=new StringRequest(Request.Method.GET, "https://moviesapi.ir/api/v1/movies?page=1", response -> {
            ...
            loading1.setVisibility(View.GONE);
            Log.i("Uchi", "onErrorResponse: " + error.toString());
        });
