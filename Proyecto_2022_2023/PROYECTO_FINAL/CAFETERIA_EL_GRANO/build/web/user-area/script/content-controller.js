...
function contentController(){
    ...
    if (getCookie("accounttype") == "worker") {
        ...
        document.querySelectorAll('.private').forEach((privateElement)=>{
            privateElement.setAttribute("style", "display:none;");
        });
        document.querySelector('.grid-item-1 > div').setAttribute("style","flex-direction:column-reverse;");
    }
...
function acuerdos(){
    ...
    const $acuerdosButton3 = document.querySelector('#Boton3');
    ...
    $acuerdosButton3.addEventListener("click",()=>{
        $acuerdosContent.setAttribute("style", "display:flex")
        // $sections.style.display = "none!important";
        $sections.setAttribute("style","display:none")
    });
...
function strikes() {
    ...
    const $strikesButton2 = document.querySelector('#Boton2');
    ...
    $strikesButton2.addEventListener("click",()=>{
        $strikesContent.setAttribute("style", "display:flex")
        // $sections.style.display = "none!important";
        $sections.setAttribute("style","display:none")
    });
...
function companyHierarchy() {
    ...
    const $hierarchyButton1 = document.querySelector('#Boton1');
    console.log($hierarchyButton1);
    ...
    $hierarchyButton1.addEventListener("click",()=>{
        $hierarchyContent.setAttribute("style", "display:flex")
        // $sections.style.display = "none!important";
        $sections.setAttribute("style","display:none")
    });
